...
const defaultSiteOrigin = "https://www.yilukg.com";
...
function defaultContent() {
  return {
    ...
    about: {
      ...
      founderBody: "关凯迪是互联网品牌营销领域的老兵，也是企业AI化转型的实战派。曾任互动百科销售总监，拥有超过10年的品牌推广、流量运营与企业内容资产建设经验。\n\n他擅长把复杂的AI技术翻译成企业老板听得懂、团队能执行的商业语言，用“AI工具配置 + 品牌资产重构 + GEO搜索占位”的组合方式，帮助传统企业降低转型成本。",
      timeline: [
        {
          title: "内容品牌推广沉淀",
      ...
      <section class="section about-founder-section" aria-label="关凯迪与一路凯歌方法主线">
        ...
        <div class="about-founder-layout">
          <article class="about-founder-card">
            ...
            <p>关凯迪曾任互动百科销售总监，长期参与百科词条、企业官网、搜索呈现、新闻内容、口碑问答和品牌推广相关工作。一路凯歌延续这条能力主线，重点帮助企业把分散的公开资料整理成更稳定、更清楚、更适合被搜索引擎和 AI 引用的品牌内容资产。</p>
          </article>
    ...
    <main class="author-page">
      ...
      <section class="author-profile-grid" aria-label="关凯迪个人资料">
        <article class="author-panel">
          ...
          <h2>个人简介</h2>
          <p>关凯迪，英文名 Kaidi Guan，互联网品牌营销领域从业者，一路凯歌创始人。曾长期参与百科词条、新闻营销、口碑内容、企业官网和新媒体内容建设等项目，关注企业在公开互联网中的品牌信息一致性和可检索性。</p>
