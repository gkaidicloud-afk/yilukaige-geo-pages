...
export const july5Articles = [
  article({
      "slug": "doubao-ai-search-customer-leads-change-acquisition",
      "title": "从豆包咨询线索看：AI 搜索正在改变企业获客方式",
      "summary": "越来越多企业主开始直接向 AI 提问寻找服务商。一路凯歌从豆包搜索咨询线索看到，AI 搜索正在把企业获客入口前移：企业需要先让 AI 理解自己是谁、能解决什么问题、是否值得被推荐。",
      "category": "AI 搜索优化",
      "keywords": "豆包AI搜索,AI搜索获客,GEO优化,品牌AI推荐,AI可见度,企业AI服务,AI可引用信源,一路凯歌",
      "seoDescription": "越来越多企业主开始直接向 AI 提问寻找服务商。一路凯歌从豆包搜索咨询线索看到，AI 搜索正在把企业获客入口前移：企业需要先让 AI 理解自己是谁、能解决什么问题、是否值得被推荐。",
      "date": "2026-07-08",
      "datetime": "2026-07-08T22:20:00+08:00",
      "feedDate": "Wed, 08 Jul 2026 22:20:00 +0800",
      "sourceNote": "本文根据一路凯歌在 AI 搜索与 GEO 优化咨询中的一线观察整理，用于说明豆包等 AI 搜索入口正在改变企业获客路径。",
      "cover": {
          "title": "从豆包咨询线索看：AI 搜索正在改变企业获客方式",
          "kicker": "AI SEARCH LEADS",
          "tag": "客户开始问 AI，企业需要先被 AI 理解",
          "points": [
              "识别获客入口变化",
              "补齐品牌实体信息",
              "建立公开信源体系"
      ...
      "sections": [
          {
              ...
              "images": [
                  {
                      "src": "assets/doubao-ai-search-customer-leads-change-acquisition-three-information.png",
                      "alt": "要被 AI 推荐，企业需要补齐品牌实体信息、业务事实信息和公开信源信息",
                      "caption": "要被 AI 推荐，企业需要先补齐品牌实体信息、业务事实信息和公开信源信息。",
                      "width": 1456,
                      "height": 1048
                  }
              ]
      ...
      "faqs": [
          {
              "question": "AI 搜索来的客户有价值吗？",
              "answer": "通常更有价值，因为用户往往带着明确问题和决策意图。"
          },
          {
              "question": "企业应该马上做什么？",
              "answer": "先整理品牌实体、服务页、FAQ、案例和高意图问答内容。"
          },
          {
              "question": "为什么不能只写几篇软文？",
              "answer": "因为 AI 更关注公开信息是否稳定、一致、可验证。软文数量多但主体、服务和联系方式混乱时，反而不利于形成可信答案。"
          },
          {
              "question": "GEO 对本地服务商和 B2B 企业有什么意义？",
              "answer": "它不一定马上带来爆发式流量，但能帮助企业建立新的被发现入口，让 AI 在用户提问时更容易理解、引用和推荐企业。"
          }
      ]
  }),
  article({
      "slug": "geo-not-press-release-ai-citable-source-system",
      "title": "GEO 不是发新闻稿，而是建立 AI 可引用信源体系",
      "summary": "现在很多企业听到 GEO，第一反应是“是不是多发新闻稿就行”。这个理解只对了一小半。新闻稿、问答、公众号、官网文章确实是信源，但 GEO 的重点不是堆内容数量，而是让 AI 能从这些内容里抽取稳定、准确、可复用的品牌事实。",
      "category": "GEO 优化",
      "keywords": "AI 可引用信源、GEO 信源体系、新闻源发布、品牌实体优化、AI 搜索优化、GEO优化、一路凯歌",
      "seoDescription": "现在很多企业听到 GEO，第一反应是“是不是多发新闻稿就行”。这个理解只对了一小半。新闻稿、问答、公众号、官网文章确实是信源，但 GEO 的重点不是堆内容数量，而是让 AI 能从这些内容里抽取稳定、准确、可复用的品牌事实。",
      "date": "2026-07-06",
      "datetime": "2026-07-06T11:58:00+08:00",
      "feedDate": "Mon, 06 Jul 2026 11:58:00 +0800",
      "sourceNote": "本文根据一路凯歌 GEO 内容资料整理，用于说明企业如何从单点发稿转向 AI 可引用信源体系建设。",
      "cover": {
          "title": "GEO 不是发新闻稿，而是建立 AI 可引用信源体系",
          "kicker": "GEO SOURCE SYSTEM",
          "tag": "让 AI 能抽取稳定、准确、可复用的品牌事实",
          "points": [
              "统一品牌事实",
              "建立信源矩阵",
              "持续测试复盘"
      ...
      "sections": [
          {
              ...
              "images": [
                  {
                      "src": "assets/geo-not-press-release-ai-citable-source-system-source-system.png",
                      "alt": "GEO 不是发新闻稿，而是建立 AI 可引用信源体系",
                      "caption": "GEO 的重点不是单纯发稿，而是把官网、FAQ、新闻源、案例和问答组织成 AI 可引用的品牌事实体系。",
                      "width": 1268,
                      "height": 951
                  }
              ]
      ...
      "faqs": [
          {
              "question": "新闻稿还有价值吗？",
              "answer": "有价值，但新闻稿应服务于信源建设，而不是孤立发布。"
          },
          {
              "question": "企业最先补什么？",
              "answer": "先补官网服务页、FAQ、公司介绍、案例和高意图问答。"
          },
          {
              "question": "GEO 为什么不能只看发稿数量？",
              "answer": "因为 AI 更关注公开信息是否稳定、一致、可验证。内容数量多但主体、服务、案例和联系方式混乱时，反而不利于形成可信答案。"
          },
          {
              "question": "AI 可引用信源体系包含哪些内容？",
              "answer": "通常包含官网服务页、公司介绍、新闻源、FAQ、案例材料、问答内容、自媒体资料和持续复盘记录。"
          }
      ]
  }),
  article({
